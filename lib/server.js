...
const cannedRes   = require('./web/canned-responses')
const mapRequest  = require('./web/request-mapper')
...
function initMw(ctx) {
    const {sway, args: { host, port }} = ctx
    sway.host = 
      sway.definition.host = 
        sway.definitionFullyResolved = host + ':' + port
